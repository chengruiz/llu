...
TEST(LLU_RANGE_TEST, LLU_RANGE_TEST) {
  ...
  ASSERT_NEAR(llu::interpolate(range, 0.0), 0.0, llu::kEPS) << "Interpolate({0, 2}, 0.0) should be 0.0";
  ASSERT_NEAR(llu::interpolate(range, 0.5), 1.0, llu::kEPS) << "Interpolate({0, 2}, 0.5) should be 1.0";
  ASSERT_NEAR(llu::interpolate(range, 1.0), 2.0, llu::kEPS) << "Interpolate({0, 2}, 1.0) should be 2.0";
}
